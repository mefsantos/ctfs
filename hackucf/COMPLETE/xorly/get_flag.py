...
hex_cipher = "2e0c010d46000048074900090b191f0d484923091f491004091a1648071d070d081d1a070848"
cipher = hex_cipher.decode("hex")
key = decrypt(cipher, plaintext)
#print key
hex_flag = "0005120f1d111c1a3900003712011637080c0437070c0015"
cipher_flag = hex_flag.decode("hex")
print decrypt(cipher_flag, key)
